      ...
      <Modal v-model="showModal" :title="formValidate.id ? $t('setUpPage.editAdmin') : $t('setUpPage.addAdmin')" :mask-closable="false">
        ...
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
          <FormItem :label="$t('setUpPage.name')" prop="description">
            <Input v-model="formValidate.description" :placeholder="$t('setUpPage.nameTip')" maxlength="50"></Input>
          </FormItem>
          <FormItem :label="$t('setUpPage.phoneNumber')" prop="phoneNumber">
            <Input v-model="formValidate.phoneNumber" :placeholder="$t('setUpPage.phoneNumberTip')" maxlength="50"></Input>
          </FormItem>
          <FormItem :label="$t('setUpPage.username')" prop="username">
            <Input v-model="formValidate.username" :placeholder="$t('setUpPage.usernameTip')" maxlength="50"></Input>
          </FormItem>
          <FormItem :label="$t('setUpPage.password')" prop="password" v-if="!formValidate.id" key="addPassWord">
            <Input v-model="formValidate.password" :placeholder="$t('setUpPage.password')" maxlength="50"></Input>
          </FormItem>
          <FormItem :label="$t('setUpPage.password')" v-if="formValidate.id" key="editPassWord">
            <Input v-model="formValidate.password" :placeholder="$t('setUpPage.password')" maxlength="50"></Input>
          </FormItem>
