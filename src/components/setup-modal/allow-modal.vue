      ...
      >
        ...
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
          <FormItem :label="$t('setUpPage.charactor')" prop="name">
            <Input v-model="formValidate.name" :placeholder="$t('setUpPage.charactorTip')" maxlength="50"></Input>
          </FormItem>
          <FormItem :label="$t('rolePage.description')" prop="description">
            <Input v-model="formValidate.description" :placeholder="$t('rolePage.descriptionTip')" maxlength="50"></Input>
          </FormItem>
        </Form>
