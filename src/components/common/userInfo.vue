  ...
  <Modal v-model="showModal" :title="$t('userInfo.usrInfo')"
        ...
        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="150">
          <FormItem :label="$t('userInfo.name')">
            <Input v-model="formValidate.name" :placeholder="$t('userInfo.inputName')" readonly="readonly" maxlength="30"></Input>
          </FormItem>
          <FormItem :label="$t('userInfo.department')">
            <Input v-model="formValidate.department"  :placeholder="$t('userInfo.inputDepartment')" readonly maxlength="30"></Input>
          </FormItem>
          <FormItem :label="$t('userInfo.permission')">
            <Input v-model="formValidate.permission"  :placeholder="$t('userInfo.inputPermission')" readonly maxlength="30"></Input>
          </FormItem>
          <FormItem :label="$t('userInfo.phone')" prop="phoneNumber">
            <Input v-model="formValidate.phoneNumber" :placeholder="$t('userInfo.inputPhone')" maxlength="30"></Input>
          </FormItem>
        </Form>
        <div slot="footer">
