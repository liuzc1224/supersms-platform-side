...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        {
          title: this.$t('rolePage.charactor'), key: 'name',minWidth:100,align: 'center',tooltip:true
        },
        {
          title: this.$t('rolePage.description'), key: 'description',minWidth:100,align: 'center',tooltip:true
        },
        {
