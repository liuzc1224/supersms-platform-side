...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        {
          title: this.$t('setUpPage.departament'), key: 'departmentDTOS',minWidth:100,align: 'center',
          render: (h, params) => {
            let role = ''
        ...
        {
          title: this.$t('setUpPage.name'), key: 'description',minWidth:100,align: 'center',tooltip:true
        },
        {
          title: this.$t('setUpPage.username'), key: 'username',minWidth:100,align: 'center',tooltip:true
        },
        {
          title: this.$t('setUpPage.phoneNumber'), key: 'phoneNumber',minWidth:100,align: 'center',tooltip:true
        },
        {
          title: this.$t('setUpPage.charactor'), key: 'roleOutputVOS',minWidth:100,align: 'center',tooltip:true,
          render: (h, params) => {
            let role = ''
